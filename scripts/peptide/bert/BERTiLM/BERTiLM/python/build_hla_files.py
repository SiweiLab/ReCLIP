"""
Create combined HLA/MHC datasets for the SWING baseline.
...
def main():
    ...
    for file in netmhc_files: 
        ## load dataset
        net_mhc = pd.read_csv(file, sep = r'\s+', names = ['Epitope', 'Hit', 'MHC'], header = None)
        ...
        ## Build labels that match the chain sequence table
